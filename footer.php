			...
			<footer class="footer-area section-gap">
				<div class="container">
					...
					<div class="row footer-bottom d-flex justify-content-between align-items-center">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || <br> Geographic Information System President University</i> <br> by Group 4 : Alicia, Auliya, Kayla, Naydeline, Ratu</a>
</p>
